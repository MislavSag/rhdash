...
valueBox(value = new_cases_today$cases, icon = "angry", caption = 'Broj novih COVID19 slučajeva', color = "red")
...
new_cases_today <- Cn19[date == as.Date(as.POSIXct(last_biz_day,'UTC'))]
valueBox(value = new_cases_today$deaths, icon = "", caption = 'Broj smrtnih COVID19 slučajeva', color = "black")
