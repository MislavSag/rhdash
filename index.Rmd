...
# generate data_daily folder igf it doesn't exist
# this is temporrary folder where we save data from 
# court registry , so we don't have towait to downlaod it
...
# MISLIM DA NEMA POTREBE OVO SPREMATI!
...
valueBox(value = new_cases_today$cases, icon = "fa-user-plus", caption = 'Broj novih COVID19 slučajeva', color = "green")
...
new_cases_today <- Cn19[date == as.Date(as.POSIXct(last_biz_day,'UTC'))]
valueBox(value = new_cases_today$deaths, icon = "fa-user-plus", caption = 'Broj smrtnih COVID19 slučajeva', color = "red")
...
dnT <- new_deaths_today %>%
  ...
  as.numeric()
valueBox(value = dnT, icon = "fa-user-plus", caption = 'Broj dana za uduplavanje COVID19 slučajeva', color = "red")
...
valueBox(value = paste0(crobex_today,"%"), icon = "fa-user-plus", caption = 'CROBEX promjena', color = "green")
