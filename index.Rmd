...
dnT <- new_deaths_today %>% select(doubleTime) %>% as.numeric()
valueBox(value = dnT, icon = "fa-user-plus", caption = 'Broj smrtnih COVID19 slučajeva', color = "red")
...
### Stopa uduplavanja COVID-19 slučajeva
